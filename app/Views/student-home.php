...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item ">
				<a class="nav-link" href="<?php echo base_url();?>/guid"><i class="far fa-clone"></i>Guidance</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url();?>/std-view-pros"><i class="far fa-edit"></i>Professionals</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url();?>/stdJobView"><i class="far fa-chart-bar"></i>Jobs</a>
			</li>
			<li class="nav-item">
