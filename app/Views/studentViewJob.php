...
<body>
	<nav class="navbar navbar-expand-custom navbar-mainbg" style="padding-bottom: 0px;">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url();?>/std-view-pros"><i class="fas fa-users"></i>Professionals</a>
			</li>
					...
					<div class="col-sm-12 col-md-3 img-head-color mt-4 col-lg-3  col-xl-2">
						...
						<div class="prof-pic">
							...
							<div class="Profile-Details">
								<i class="fa fa-mobile" aria-hidden="true" style="color: #31918f;font-size:25px";></i><a  href="tel:<?php echo $value->sd_phone;?>" style="padding-left: 10px;margin-top:2px;"><?php echo $value->sd_phone;?></a><br>
								  <?php if($value->s_school)
								  { ?>
								<i class="fa-solid fa-school " aria-hidden="true" style="color: #31918f;font-size:15px";></i> <?php echo $value->s_school;?><br>
								<i class="fa fa-map-marker" aria-hidden="true" style="color: #31918f;font-size:23px";></i> <?php echo $value->s_place;?><br>
								<?php }else{
...
<?php foreach($job as $value)
{
	?>
					<div class="card mt-2 job-sec ">
						...
						<a  class="btn btn-warning" href="mailto:<?php echo $value->h_fk_id;?>">Applay</a>
