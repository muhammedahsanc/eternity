...
<body>
 ...
 <form action="<?php echo base_url();?>/insertJob" autocomplete="off" enctype="multipart/form-data" method="post" name="jobpost" class="jobpost"> 
						...
						<div class="login-cust">
							...
							<div class="login-card card">
								<div class="as">
									...
									<input type="text" class="form-control mt-1 "  id="Username" placeholder="Company name" name="job_com_name">
									<label>Job details :</label>
											<input type="text" class="form-control mt-1" id=""  placeholder="Details" name="job_details">
										
									<label class="mt-1">What position are you hire :</label>
									<div class="cust-border">
									<input type="text" class="form-control mt-1" id=""  placeholder="Position" name="job_position">
										<label class="">Salary :</label>
									<input type="text" class="form-control mt-1"  id="" placeholder="Salary" name="job_salary">
										<label class="">Skills :</label>
									<input type="text" class="form-control mt-1" id=""  placeholder="Skills" name="job_skills">
										<label>Experience :</label>
										<input  type="text" class="form-control login-password mt-1"  id="" placeholder="eg:-1yr+" name="job_experience" >
					
										<label>Photo :</label><br>
										      <input type="file" class="form-control" id="galimage" name="job_photo"><img width="180px" id="loadImage" src="">
