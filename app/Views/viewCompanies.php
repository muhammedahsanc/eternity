	...
	<div class="container-fluid">
		<div class="container">
			...
			<?php foreach($data as $value){
				?>
				<div class="col-sm-12 col-md-3 img-head-color mt-4 col-lg-3  col-xl-2" style="background-color: #475C7A !important;overflow: auto;">
					<img  src="<?php echo base_url();?>\companyImages\<?php echo $value->c_photo	;?>">
					<div class="prof-pic">

						<center><h6 class="profile-name"><?php echo $value->c_name;?></h6></center>
						<center><a class="profile-name" href="mailto:<?php echo $value->c_email;?>" ><i class="fa fa-envelope" style="color: #31918f;font-size:25px"></i></a></center> 
						<br>
						<div class="Profile-Details">
							<i class="fa fa-mobile" aria-hidden="true" style="color: #31918f;font-size:25px"></i><?php echo $value->c_phone;?><br>
							<a  href="mailto:<?php echo $value->c_email;?>" ><i class="fa fa-envelope" style="color: #31918f;font-size:16px"></i><?php echo $value->c_email;?></a><br>
							<i class="fa-solid fa-link" aria-hidden="true" style="color: #31918f"></i><a href="<?php echo $value->c_website;?>"> <?php echo $value->c_website;?></a><br>
							<i class="fa fa-building" aria-hidden="true" style="color: #31918f"></i><?php echo $value->c_branches;?><br>
							<i class="fa fa-info-circle" aria-hidden="true" style="color: #31918f"></i><?php echo $value->c_about;?><br>
