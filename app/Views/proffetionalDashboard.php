...
<div class="col-xxl-7">
 <img src="<?php echo base_url();?>\assets\images\profile\prodash.jpg" style="width: 100%;height: 100%;">
</div>
                ...
                <div class="row">                       
                    <div class="col-lg-4 col-sm-4 col-xs-12">
                        <div class="single_footer">
                            <h4>Services</h4>
                            <ul>
                                <li><a href="<?php echo base_url();?>/JobsProProfile">Job section</a></li>
                                <li><a href="<?php echo base_url();?>/proviewpros">Meet professionals</a></li>
                                <li><a href="<?php echo base_url();?>/proviewcom">Contact companies  </a></li>
